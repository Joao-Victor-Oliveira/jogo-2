...
void Jogador::inicializa() {
    animacao.addAnimacao("imagens/Jogador/Anda.png", "ANDANDO", 8, 0.12f, sf::Vector2f(6,8));
    animacao.addAnimacao("imagens/Jogador/Ataca.png", "ATACANDO", 6, 0.1f, sf::Vector2f(6,8));
    animacao.addAnimacao("imagens/Jogador/Parado.png", "PARADO", 8, 0.15f, sf::Vector2f(6,8));
    animacao.addAnimacao("imagens/Jogador/Pula.png", "PULANDO", 2, 0.15f, sf::Vector2f(6,8));
    animacao.addAnimacao("imagens/Jogador/Cai.png", "CAINDO", 2, 0.15f, sf::Vector2f(6,8));
    animacao.addAnimacao("imagens/Jogador/Morre.png", "MORRENDO", 6, 0.15f, sf::Vector2f(6,8));
    animacao.addAnimacao("imagens/Jogador/TomaDano.png", "TOMANDO_DANO", 4, 0.15f, sf::Vector2f(6,8));
